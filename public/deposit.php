...
<body class="h-screen bg-gradient-to-br from-black via-gray-900 to-gray-800 flex">
  ...
  <aside class="w-64 bg-gray-950 text-white flex flex-col">
    ...
    <nav class="flex-1 p-4 space-y-4">
      ...
      <a href="deposit.php" class="block px-4 py-2 rounded-lg bg-gray-800">💸 Deposit</a>
    ...
    <section class="bg-gray-900 p-6 rounded-xl shadow-lg w-full max-w-md">
      <form method="POST" class="space-y-4">
        <div>
          ...
          <input type="number" step="0.01" name="amount" class="w-full p-2 rounded-lg bg-gray-800 text-white focus:ring focus:ring-green-500" required>
        </div>
        <button type="submit" class="w-full py-2 bg-green-600 hover:bg-green-700 rounded-lg font-bold">Deposit</button>
      </form>
    </section>
